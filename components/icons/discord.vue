<template>
  <svg viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none">
      ...
      <g id="SVGRepo_iconCarrier">
          <path stroke-linecap="round" fill="none" stroke-linejoin="round" stroke-width="6"
          ...
          <ellipse cx="71" cy="101" rx="13" ry="15"></ellipse>
          <ellipse cx="121" cy="101" rx="13" ry="15"></ellipse>
      </g>
  </svg>
</template>