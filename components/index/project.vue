  ...
  <div class="min-h-screen py-16">
    ...
    <div class="mt-10">
      ...
      <div class="grid grid-cols-2 gap-4">
        <!-- project items -->
        <div class="col-span-1 md:col-span-1" v-for="n in 4" :key="n">
          <div class="flex items-end justify-between">
            <div class="text-xl font-semibold">judul project</div>
            <div class="font-semibold">02, 08, 2023</div>
          </div>

          <div class="aspect-video bg-neutral rounded-xl mt-2"></div>
          <div class="flex gap-2 overflow-hidden mt-2">
